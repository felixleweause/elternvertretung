-- Extend events & rsvps with reminder settings, helper functions and RLS.

alter table public.events
  add column if not exists remind_24h boolean not null default false,
  add column if not exists remind_2h boolean not null default false;
